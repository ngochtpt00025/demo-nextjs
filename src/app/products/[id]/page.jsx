import { listProduct } from "../page";
const UProduct = ({ id }) => {
    const product = listProduct.find(p => p.id === id);
    let badgeElement;
    if (product.badge !== null) {
        badgeElement = (
            <div className={`product-badge product-badge-${product.badge === "New" ? "new" : "sale"}`}>
    ...
    return (
        <div className="product-item">
            ...
            <div className="product-details">
                ...
                <p className="product-sub-description">{product.subDescription}</p>
                <div className="product-price">
                    <ins>{product.current}</ins>
                    {product.originalPrice !== null ? (<del>{product.originalPrice}</del>) : <></>}
                </div>
            </div>
