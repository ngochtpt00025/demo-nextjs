        ...
        <>
            ...
            <div className={`offcanvas offcanvas-end ${isOpen ? 'show' : 'hide'}`} tabIndex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
                ...
                <div className="offcanvas-footer">
                    <div className="total-price border-bottom pb-4">
                        <span className="total-price-text">Sub Total:</span>
                        <span className="total-price-value">Rs 14.000.000</span>
                    </div>
                    <div className="ben-cart">
                        <button className="btn-cart">Checkout</button>
                        <button className="btn-cart"><a href="./cart.html">View Cart</a></button>
                        <button className="btn-cart">Comparison</button>
                    </div>
                </div>
            </div>
        </>
