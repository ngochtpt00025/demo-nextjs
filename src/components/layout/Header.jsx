        ...
        <header className="header">
            <div className="header-items">
                <Link href="/" className="logo">
                    <img
                        src="/assets/images/Meubel House_Logos-05.png"
                        alt="Furniro Logo"
                    />
                    <span className="shop-name">Furniro</span>
                </Link>
                <nav className="desktop-nav">
                    <ul className="nav-menu">
                        <li><Link href="" className="nav-link">Home</Link></li>
                        <li><Link href="" className="nav-link">Shop</Link></li>
                ...
                <div className="header-actions">
                    <div className="desktop-icons">
                        ...
                        <button className="icon cart-icon" id="open-offcanvas-cart" data-bs-toggle="offcanvas"
